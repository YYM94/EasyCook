	...
	<form name="m" method="post">
		<div id="mp_search">
			...
			<div id="mp_title_list">
				<input type="button" id="mp_btn_comment_1" value="나의 댓글" onclick="location.href='mp_comment_list';"/>	
			...
			<tr style="background-color:#f5f5f5;">
				...
				<td>0</td>
				<td>2021.01.01</td>
				<td><input type="button" value="수정" onclick="location.href='#';"/>
				<input type="button" value="삭제" onclick="location.href='#';"/></td>
				</tr>
			<%} %>			
		</table>	
